...
- (NSCachedURLResponse *)dataFromRequest:(NSURLRequest *)request {
    ...
    if ([url isEqualToString:@"http://m.baidu.com/static/index/plus/plus_logo.png"])
    {
        NSString *p = [[NSBundle mainBundle] pathForResource:@"left_button_hightlight@2x" ofType:@"png"];
